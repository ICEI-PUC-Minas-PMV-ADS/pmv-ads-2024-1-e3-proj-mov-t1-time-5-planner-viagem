...
|-------|------------------------------------------------------------------|------------|
|RF-001 | Os usuários devem poder se cadastrar na aplicação fornecendo:    | ALTA      |
|       | - **Nome de usuário único:**                                     |            |
|       |   - Entre 6 e 12 caracteres.                                    |            |
|       |   - Pode conter letras maiúsculas e minúsculas, números e sublinhados (_). |            |
|       |   - Não pode conter espaços ou caracteres especiais.            |            |
|       | - **Endereço de e-mail único:**                                 |            |
|       |   - Seguir o formato padrão (ex: nomeusuario@dominio.com).      |            |
|       | - **Senha:**                                                   |            |
|       |   - No mínimo 8 caracteres.                                    |            |
|       |   - Deve conter pelo menos uma letra maiúscula, uma letra minúscula, um número e um caractere especial. |            |
|       |   - Não pode conter palavras do dicionário ou sequências óbvias (ex: 123456, abcdef). |            |
